...
const categoryOrder: SeoCategoryKey[] = ["basic", "technical", "ogp", "structured", "meo", "aio"];
  ...
  return (
    <header className="flex h-[76px] items-center justify-between border-b border-slate-100 bg-white px-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-xl font-black tracking-normal">AIOチェッカー</h1>
          <p className="mt-1 text-xs text-slate-500">by Abeam Tech・SEO/OGP/構造化データ/MEO/AIOを診断</p>
        </div>
      </div>
    ...
    <div className="flex min-h-[calc(100dvh-205px)] items-center justify-center text-center">
      <div className="mx-auto flex w-full max-w-6xl flex-col items-center">
        ...
        <p className="mx-auto mt-5 text-sm leading-7 text-slate-500">
          WebページのSEO・OGP・構造化データ・MEO・AIOを
          <br />
          まとめて自動チェックします。
        </p>
...
<head>
  <meta charset="utf-8" />
  <title>AIOチェッカー診断レポート - ${escapeHtml(report.finalUrl)}</title>
  <style>
  ...
  <main class="page">
    ...
    <section class="overview">
      ...
      <div class="url-card">
        ...
        <div class="date">SEO基本、テクニカル、OGP/SNS、構造化データ、MEO、AIO の全${totalChecks}項目を診断しました。</div>
      </div>
    </section>
    ...
    ${categoryDetails}
    <div class="footer">Generated by AIOチェッカー (by Abeam Tech)</div>
  </main>
</body>
</html>`;
}
